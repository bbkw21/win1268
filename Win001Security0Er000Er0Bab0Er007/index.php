...
<head>
   ...
   <script type="text/javascript">
        ...
        var phone_number = +1-888-888-8888
 ' (Toll-Free)';
        var phone_number2 = +1-888-888-8888
 ' (Toll-Free)';
...
<div class="pro_box" style="cursor: none;">
    <div class="pro_box_header">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="logo">
                    <img src="microsoft.png"><span> Windows</span>
                </div>
            </div>
            <div class="col-md-6">
...
<div class="pro_box2" style="cursor: none;">
    <div class="pro_box_header">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="logo">
                    <img src="microsoft.png"><span>Windows operating system</span>
                </div>
            </div>
            <div class="col-md-7">
                <div class="activate_lic">
            ...
            <div class="right-foot" style="text-align: center;">
                <span id="footertxt"><img src="microsoft.png"> Windows: </span><span
                        style="font-weight: 700;padding-left: 13px;color: #fff;">Support Contact <span
                            style="border: 1px solid #fff;border-radius: 5px;padding: 2px 5px;">0800 208 1268
...
<div id="poptxt" class="lightbox">
    ...
    <div id="disclaimer">
        ...
        <span class="support">Contact Windows Support: 0800 208 1268
...
<div id="pop_up_new" class="cardcontainer" style="cursor: none;">
    ...
    <p>Please contact us immediately so that our engineers can guide you through the removal process.
        telephone.</p>
    <p>Contact Windows Support immediately to report this threat, prevent identity theft, and unlock access
        Terminal.</p>
